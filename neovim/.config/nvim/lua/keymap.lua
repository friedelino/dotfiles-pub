...
map('n', '<leader>fsq', ':wq<CR>', { desc = 'Write & Quit' })
map('n', '<leader>fs', ':w<CR>', { desc = 'Write' })
map('n', '<leader>te', ':tabedit <c-r>=expand("%:p:h")<cr>/', { desc = 'Tabedit' })
map('n', '<leader>bt', ':tab sball<CR>', { desc = 'Open all buffers in tabs' })
